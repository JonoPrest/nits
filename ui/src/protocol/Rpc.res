...
module Request = {
  ...
  type t =
    ...
    | DiscoverReviews({query: Domain.ReviewQuery.t})
    | ListComments({@as("review_id") reviewId: reviewId, query: Domain.CommentQuery.t})
...
module Response = {
  ...
  type t =
    ...
    | CommentListing({listing: Domain.CommentListing.t})
