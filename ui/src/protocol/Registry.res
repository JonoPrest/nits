...
let schemas: dict<S.t<unknown>> = Dict.fromArray([
  ...
  ("CommentThreadStatus", erase(Domain.CommentThreadStatus.schema)),
  ("CommentQuery", erase(Domain.CommentQuery.schema)),
  ("CommentThread", erase(Domain.CommentThread.schema)),
  ("CommentSummary", erase(Domain.CommentSummary.schema)),
  ("CommentListing", erase(Domain.CommentListing.schema)),
