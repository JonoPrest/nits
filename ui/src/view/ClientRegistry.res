...
let schemas: dict<S.t<unknown>> = Dict.fromArray([
  ...
  ("DaemonManagement", erase(View.DaemonManagement.schema)),
  ...
  ("SuggestionView", erase(View.SuggestionView.schema)),
  ("SuggestionStatus", erase(View.SuggestionStatus.schema)),
  ...
  ("BrowseTarget", erase(View.BrowseTarget.schema)),
  ("BrowseStatus", erase(View.BrowseStatus.schema)),
  ("BrowseAttemptView", erase(View.BrowseAttemptView.schema)),
  ("BrowseView", erase(View.BrowseView.schema)),
  ("RefSelectorPurpose", erase(View.RefSelectorPurpose.schema)),
