...
1. Call MCP `get_review` with the original `review_id`. Inspect `review.targets`
...
2. Call `update_review` with the original ID, its existing title, and
